...
const FormFilters = () => {
  ...
  return <Container dark={dark}>
          <div className="input-content">
            ...
            <input type="text" value={filter.name} placeholder="Filter by title..." onChange={(e)=>dispatch(name(e.target.value))} id='title'/>
          </div>
          <div className="input-content">
            <label htmlFor="location"><Location /></label>
            <input type="text" value={filter.location} id='location' placeholder='Filter by location...' onChange={(e)=>dispatch(location(e.target.value))}/>
          </div>
          <div className="input-content">
            <input type="checkbox" id='time' checked={filter.fulltime} onChange={()=>dispatch(fulltimetoggle()) } />
...
const Container = styled.form`
   ...
   >*{
     ...
     input[type=text]{
      ...
      color:${props => props.dark?colors.dark.fontcolor:colors.light.fontcolor};
      outline:none;
      width:100%;
      height:100%;
     }
